...
[![Build Status](https://travis-ci.org/nacos-group/nacos-sdk-go.svg?branch=master)](https://travis-ci.org/nacos-group/nacos-sdk-go) [![Go Report Card](https://goreportcard.com/badge/github.com/easystack/nacos-sdk-go-v1x)](https://goreportcard.com/report/github.com/easystack/nacos-sdk-go-v1x) ![license](https://img.shields.io/badge/license-Apache--2.0-green.svg)
...
使用`go get`安装SDK：
```sh
$ go get -u github.com/easystack/nacos-sdk-go-v1x
```
## 快速使用
* ClientConfig
